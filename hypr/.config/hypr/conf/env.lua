...
-- Route Qt theming through qt6ct. Without this, Dolphin renders with the
-- default light Fusion palette no matter what GTK is doing -- the `breeze`
-- widget style is not installed here, only `breeze-icons`.
-- qt6ct.conf and its color scheme are generated by `theme-set`.
